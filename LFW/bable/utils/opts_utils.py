...
def parse_args(args=None):
    ...
    # dataset
    parser.add_argument('--dataset-type', type=str, default="zappos_v4")
    ...
    parser.add_argument('--init-im-size', type=int, default=32)
    ...
    parser.add_argument('--logs-name', type=str, default="final")
