...
# load cls
# load ranker model
ckpt_path = 'pretrained_ranker/smile.pth'
...
datas = train_data[:n_check]
print(datas.shape)


# evaluate real data's score by a surrogate ranker
load_model_path = 'results/adversarial_ranking_Smiling/1/'

model_epochs = [199999]  #np.arange(199999, 200000, 200000)
