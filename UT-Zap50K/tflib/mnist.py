...
def load(batch_size, test_batch_size, n_labelled=None):
    filepath = '/home/yinghua/data/mnist/mnist.pkl.gz'
    ...
    with gzip.open('/home/yinghua/data/mnist/mnist.pkl.gz', 'rb') as f:
...
def load_train_data(batch_size, test_batch_size, n_labelled=None):
    filepath = '/home/yinghua/data/mnist/mnist.pkl.gz'
    url = 'http://www.iro.umontreal.ca/~lisa/deep/data/mnist/mnist.pkl.gz'
...
if __name__ == '__main__':
    train_data = load_train_data(64, 64)
