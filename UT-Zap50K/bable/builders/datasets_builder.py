from bable.datasets.zappos_dataset import ZapposV1, ZapposV2, ZapposV3, ZapposV4, ZapposV4Predict, ZapposV3Predict
from bable.datasets.zappos_dataset import ZapposPredictDataset, ZapposGenDataset
...
def build_dataset(dataset_type, **kwargs):
    ...
    elif dataset_type == 'zappos_v3':
        # params: split, category_id, trans_config, include_equal
        return ZapposV3(**kwargs)
    elif dataset_type == 'zappos_v4':
        # params: split, category_id, trans_config, include_equal
        return ZapposV4(**kwargs)
    elif dataset_type == 'zappos_v3_predict':
        # params: split, category_id, trans_config, include_equal
        return ZapposV3Predict(**kwargs)
    elif dataset_type == 'zappos_v4_predict':
        # params: split, category_id, trans_config, include_equal
        return ZapposV4Predict(**kwargs)
    elif dataset_type == 'zappos_predict':
        # params: min_height, min_width, is_bgr
        return ZapposPredictDataset(**kwargs)
    elif dataset_type == 'zappos_gen':
        # params: min_height, min_width, is_bgr
        return ZapposGenDataset(**kwargs)
